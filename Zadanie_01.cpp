...

{
	...
	// sprawdzenie czy implementacja biblioteki obsługuje tekstury o wymiarze 1024
...

	{
		...
		printf("Rozmiar tekstur mniejszy od 1024");
	...
	// lista wyświetlania - tekstura o szerokości 1024 tekseli
	...
	glTexImage1D(GL_TEXTURE_1D, 0, GL_RGB, 1024, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
	...
	// lista wyświetlania - tekstura o szerokości 512 tekseli
	...
	glTexImage1D(GL_TEXTURE_1D, 0, GL_LUMINANCE, 512, 0, GL_LUMINANCE, GL_UNSIGNED_BYTE, texture);
	...
	glTexImage1D(GL_TEXTURE_1D, 0, GL_INTENSITY, 256, 0, GL_RGB, GL_UNSIGNED_BYTE, texture);
